...
class Transaction(Base):
    """
    SQLAlchemy ORM Model representing a payment transaction record.
    """
    ...
    transaction_timestamp = Column(String(64), nullable=False)
    ...
    fraud_label = Column(Integer, nullable=False, default=0)
    transaction_source = Column(String(32), default="SYNTHETIC", nullable=False)
