...
export function Sidebar({ mobileOpen, onClose }) {
  ...
  const navContent = (
    <div className="flex flex-col h-full bg-[#070b17] text-slate-200 border-r border-slate-800/80 select-none">
      ...
      {/* Navigation Sections with Hidden Scrollbar */}
      ...
      {/* Sidebar Bottom Footer (Landing Page button removed) */}
      <div className="p-4 border-t border-slate-800/80 space-y-2 shrink-0 bg-slate-950/40">
